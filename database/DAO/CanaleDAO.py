...
class CanaleDAO:
    ...
    def insert(self, canale_id, nome_canale, id_affiliato, codice_licenza) -> None:
        self.cursor.execute(
    ...
    def get_user_channels(self, user_id) -> list:
    ...
    def is_license_used(self, license_code) -> bool:
