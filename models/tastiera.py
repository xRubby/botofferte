...
class Tastiera(Base):
    ...
    __tablename__ = "tastiere"

    tastiera_id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)

    nome_tastiera: Mapped[str] = mapped_column(String, nullable=False)
