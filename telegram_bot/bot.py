...
from telegram_bot.keyboards.channel_offers.channel_offers_layout_img import activate_immagine, confirm_delete_immagine, delete_immagine, edit_immagine, edit_immagini, immagine_menu, conv_add_immagine, show_immagini, conv_set_pos, conv_set_size
