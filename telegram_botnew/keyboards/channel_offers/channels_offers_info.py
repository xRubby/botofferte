...
async def channel_info(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        ...
        [InlineKeyboardButton("Layout", callback_data=f'channeloffers_layout_{channel_id}'), InlineKeyboardButton("Pannello Admin", callback_data=f'channel_adminpanel_{channel_id}')],
